...
class ProcessorLoggerTest {
    ...
    @Test
    void testLogWithControlHazardWithoutDataHazard() {
        final var instructions = List.of(
                new Instruction("000101 00100 00101 0000000000000011"),   // bne $4, $5, 3
                new Instruction("001000 00100 00100 0000000000000001"),   // addi $4, $4, 1
                new Instruction("000000 00111 00001 01000 00000 100010"), // sub $8, $7, $1
                new Instruction("100011 00000 01001 0000000000000000"),   // lw $9, 0($0)
                new Instruction("000000 00001 01001 00101 00000 100101")  // or $5, $1, $9
        );
        final var expect = String.join(
    ...
    @Test
    void testLogWithDataHazardWithBranch() {
        final var instructions = List.of(
        ...
        final var expect = String.join(System.lineSeparator(),
                ...
                "IF/ID:",
                "PC\t" + 4,
                "Instruction\t" + "00000000101001010000100000100000",
                "",
                "ID/EX:",
                "ReadData1\t" + 0,
                "ReadData2\t" + 0,
                ...
                "IF/ID:",
                "PC\t" + 8,
                "Instruction\t" + "00010000111000010000000000000001",
                "",
                "ID/EX:",
                "ReadData1\t" + 2,
                "ReadData2\t" + 2,
                ...
                "IF/ID:",
                "PC\t" + 16,
                "Instruction\t" + "00000000010000000001000000100000",
                "",
                "ID/EX:",
                "ReadData1\t" + 0,
                "ReadData2\t" + 0,
